...
pub struct PartAttributes {
    ...
    /// # Why it is here
    ///
    /// [`Table::step_assy`](crate::load::Table::step_assy) resolves
    ...
    /// ([`Table::shape_representation_of_items`](crate::load::Table::shape_representation_of_items))
    ...
    /// `StepFormat` impls in [`crate::save`] therefore destructure this field to
    ...
    ///
    /// - **Assembly EDGES.** [`crate::load::convert::AssembleEntity`] reuses this
    ...
    ///
    /// Every node [`Table::step_assy`](crate::load::Table::step_assy) returns
